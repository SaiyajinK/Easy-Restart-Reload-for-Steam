...
const MENU_ITEM_SELECTOR =
  "div#popup_target div[role='menuitem']";
const ITEM_MARKER =
  "data-restart-steam-root-item";
...
async function injectRootMenuItems(
  ...
  const menuItems =
    await waitForMenuItems(documentRef);
